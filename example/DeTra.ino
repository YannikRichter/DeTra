...
uint32_t  license[4] = {0xff, 0xff, 0xff, 0xff}; // LoRaNG_HSPF_Vitalora_1                //License für Proto1  
...
uint8_t DevEui[] = { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff }; // vitalora_1                              //device EUI Proto1


uint8_t AppEui[] = { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff }; // vitalora                                  //application identifier 

uint8_t AppKey[] = { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff }; // vitalora_1   //application key 1


/* ABP para*/                                                                                                                            // Activation By Personalization (ABP) Parameter werden direkt im Gerät gespeichert
uint8_t NwkSKey[] = { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,0xff };                   //network session key 
uint8_t AppSKey[] = { 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,0xff };                   //application session key
uint32_t DevAddr =  ( uint32_t )0xff;                                                                                              //device address
